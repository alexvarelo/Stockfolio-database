-- Migration: Initial Stockfolio Schema
-- This migration creates the complete database structure for the investment tracking platform
...
BEGIN
    RETURN QUERY
    SELECT 
        COUNT(DISTINCT h.ticker)::INTEGER as total_holdings,
